...
const index = users.find(item => item.pin === 5232);
console.log("Usuario con pin 5232: ", index);
...
console.log("index de la usuaria: ", indexUser);
console.log("la array resultante: ", users);

/* const usuaria = users.findIndex(user => {
    if (user.pin === 5232) {
      users.splice(3, 1);
    }
  });
